...
@hero.route('/heroes/<hero_id>', methods=['PUT'])
def update_hero(hero_id):
    return controllers.update_hero_by_id(hero_id)
@hero.route('/heroes/delete/<hero_id>', methods=['DELETE'])
