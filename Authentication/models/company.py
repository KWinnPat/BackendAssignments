...
class Companies(db.Model):
    ...
    users = db.relationship("Users", foreign_keys="[Users.company_id]", back_populates='company', cascade="all")
...
class CompaniesSchema(ma.Schema):
    class Meta:
        fields = ['company_id', 'company_name', 'products', 'users']
    ...
    users = ma.fields.Nested("UsersSchema", many=True, exclude=['company'])
